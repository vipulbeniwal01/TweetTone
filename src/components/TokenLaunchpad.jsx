      ...
      <div className="bg-gray-800 shadow-lg rounded-xl p-8 w-full max-w-lg border border-gray-700">
        ...
        <form className="space-y-6">
          ...
          <button
            type="button"
            onClick={createToken}
            className={`w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 px-6 rounded-lg shadow-md hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-4 focus:ring-blue-300 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
            disabled={loading}
          >
